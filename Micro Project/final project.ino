...
#define MAX_DEVICES 1 // maximum number of devices (daisy chaining)
#define CLK_PIN 13  // or SCK
#define DATA_PIN 11 // or MOSI
#define CS_PIN 10   // or SS

#define STARTING_Y_RACKET
#define STARTING_X_BALL
#define STARTING_Y_BALL
...
// number of times loop iterate per second (tick)
const uint8_t fps = 2;

// button P1 and P2 pins
const uint8_t P1DOWN = A4;
const uint8_t P1UP   = A5;
const uint8_t P2DOWN = 1;
const uint8_t P2UP   = 0;
// sounder pin
const uint8_t sounderPin = A0;
